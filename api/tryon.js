...
';
    ...
    if (outputs.length > 1 && ANT) {
      try {
        ...
        var content = [
          { type:'image', source:{ type:'base64', media_type:'image/jpeg', data: getB64(humanBase64) } },
          { type:'text', text: 'Original person' },
          { type:'image', source:{ type:'base64', media_type:'image/jpeg', data: getB64(garmentBase64) } },
        ...
        var pickTxt = cd.content && cd.content[0] && cd.content[0].text ? cd.content[0].text.trim() : '1';
